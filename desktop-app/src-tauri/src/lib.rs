...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::attest_verify,
            commands::policy_evaluate,
            commands::canary_capture_baseline,
            commands::teams_list_templates,
            commands::teams_show_template,
            commands::teams_send,
            commands::teams_receive,
            commands::teams_board,
            commands::get_agents,
