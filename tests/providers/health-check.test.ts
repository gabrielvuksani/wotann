...
// ── Tests: PROVIDER_CAPABILITY_MATRIX pins all 19 providers ─

describe("PROVIDER_CAPABILITY_MATRIX", () => {
  it("declares all 19 ProviderName values", () => {
    ...
    expect(Object.keys(PROVIDER_CAPABILITY_MATRIX)).toHaveLength(19);
  });
