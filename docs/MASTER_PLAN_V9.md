...
| App.tsx LOC | `wc -l src/ui/App.tsx` | **3615** (Tier: FINAL, drifted 3185 → 3352 → 3615 as Norse-signature primitives + cross-surface RPC handlers + design-token migration landed) |
