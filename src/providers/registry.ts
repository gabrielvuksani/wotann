...
export function createProviderInfrastructure(
  ...
  for (const auth of discoveredProviders) {
    ...
    switch (auth.provider) {
      ...
      case "free": {
        ...
        const cfg = groqKey
          ? { baseUrl: "https://api.groq.com/openai/v1", apiKey: groqKey, defaultModel: "llama-3.3-70b-versatile" }
          : cerebrasKey
          ? { baseUrl: "https://api.cerebras.ai/v1", apiKey: cerebrasKey, defaultModel: "llama-4-scout-17b-16e" }
          : { baseUrl: "https://api.groq.com/openai/v1", apiKey: "", defaultModel: "llama-3.3-70b-versatile" };
        adapters.set("free", createOpenAICompatAdapter({
          provider: "free", baseUrl: cfg.baseUrl, apiKey: cfg.apiKey,
          defaultModel: cfg.defaultModel, models: auth.models,
          capabilities: {
      ...
      case "gemini":
        adapters.set("gemini", createOpenAICompatAdapter({
          provider: "gemini",
          ...
          models: auth.models,
          capabilities: {
            supportsComputerUse: false, supportsToolCalling: true, supportsVision: true,
            supportsStreaming: true,
        ...
        break;
      case "huggingface":
        adapters.set("huggingface", createOpenAICompatAdapter({
          ...
          capabilities: {
            ...
            supportsStreaming: true,
            supportsThinking: true,
            maxContextWindow: getMaxContextWindow("huggingface", "Qwen/Qwen3-Coder-480B-A35B-Instruct"),
          },
        }));
        break;
      case "azure":
        adapters.set("azure", createOpenAICompatAdapter({
          provider: "azure", baseUrl: process.env["AZURE_OPENAI_ENDPOINT"] ?? "", apiKey: auth.token,
          defaultModel: "gpt-4o", models: auth.models,
          capabilities: {
            supportsComputerUse: false,
            supportsToolCalling: true,
            supportsVision: true,
        ...
        break;
      case "bedrock":
        adapters.set("bedrock", createOpenAICompatAdapter({
          provider: "bedrock",
        ...
        break;
      case "vertex":
        adapters.set("vertex", createOpenAICompatAdapter({
          provider: "vertex",
        ...
        break;
      case "mistral":
        adapters.set("mistral", createOpenAICompatAdapter({
          provider: "mistral",
        ...
        break;
      case "deepseek":
        adapters.set("deepseek", createOpenAICompatAdapter({
          provider: "deepseek",
        ...
        break;
      case "perplexity":
        adapters.set("perplexity", createOpenAICompatAdapter({
          provider: "perplexity",
        ...
        break;
      case "xai":
        adapters.set("xai", createOpenAICompatAdapter({
          provider: "xai",
        ...
        break;
      case "together":
        adapters.set("together", createOpenAICompatAdapter({
          provider: "together",
        ...
        break;
      case "fireworks":
        adapters.set("fireworks", createOpenAICompatAdapter({
          provider: "fireworks",
        ...
        break;
      case "sambanova":
        adapters.set("sambanova", createOpenAICompatAdapter({
          provider: "sambanova",
  ...
  const bridge = new AgentBridge({ adapters, router, rateLimiter, accountPool: resolvedAccountPool });
